...
const CreateChannel = ({ navigation, route }) => {
  ...
  const createChannel = async () => {
    ...
    try {
      const res = await fetch(`${ROOT_URL}/user/api/v1/channel/add/${spaceId}`, {
        method: "POST",
        headers: {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.infoContainer}>
        <Text style={styles.infoText}>Channels are where you can communicate with your team . {"\n"}
          Choose a unique channel name for your workspace</Text>
      </View>
